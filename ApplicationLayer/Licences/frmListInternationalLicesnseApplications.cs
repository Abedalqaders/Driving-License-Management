...
namespace DVLD.Applications.International_License
{
    public partial class frmListInternationalLicesnseApplications : Form
    {
        ...
        {
            _dtInternationalLicenseApplications = clsInterNationalLIcences.GetAllInternationalLicenses();
        ...
        {
            frmAddNewInterNatoinalLicences frm = new frmAddNewInterNatoinalLicences();
            frm.ShowDialog();
            //refresh
